...
async def fetch_Australia(
    ...
    """
    print("[Auckland.py] fetch_Australia: Starting fetch from Auckland...", flush=True)
    ...
    try:
        ...
        for endpoint in Australia_ENDPOINTS:
            print(f"[Auckland.py] fetch_Australia: Downloading {endpoint}", flush=True)
        ...
        print(
            f"[Auckland.py] fetch_Australia: Fetched {len(results)} Auckland stops",
            flush=True,
        )
        ...
        if close_client:
            await client.aclose()
            print("[Auckland.py] fetch_Australia: Client closed", flush=True)
